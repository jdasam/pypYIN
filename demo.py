...
from pypyin.pYINPtNote import pYINPtNote

if __name__ == "__main__":
    dir = os.path.dirname(os.path.realpath(__file__))
    srcpath = os.path.join(dir, 'src', 'pypyin')
    sys.path.append(srcpath)

    # initialise
    filename1 = os.path.join(srcpath, 'testAudioLong.wav')
    fs = 44100
    frameSize = 2048
    hopSize = 256

    pYINPtNote(filename1, fs, frameSize, hopSize)
